...
import type { NeighbourVouch } from '#/features/application/types/neighbour-vouching.types'
...
describe('Neighbour Vouching Steps', () => {
  ...
  describe('CompletedStep', () => {
    it('renders welcome message and summary card', () => {
      ...
      render(<CompletedStep fullName="John Doe" faceIdEnabled={true} onFinish={onFinish} />)
