  ...
  return (
    <div className="flex h-full w-full flex-col bg-white">
      ...
      <div className="shrink-0 px-6 pt-6 md:pt-12">
        <div className="relative w-full aspect-[4/3] max-h-[350px] overflow-hidden rounded-t-[24px] bg-gray-100">
          <img
            src={HERO_IMAGE}
            alt="Rezzident hero"
            className="h-full w-full object-cover lg:object-[center_-70px] pointer-events-none select-none"
          />
          {/* Dark overlay */}
          <div
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="flex items-center gap-2 font-dmsans text-[28px] font-bold text-white">
              <img src="/assets/logo.svg" alt="rezzident logo" className="h-[28px] w-auto" />
              rezzident
            </h1>
          </div>
        </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center overflow-hidden w-full px-10">
      ...
      <div className="flex flex-col gap-4 bg-white px-6 pb-8">
        ...
        <Link
          ...
          className="mt-2 text-center font-dmsans text-body-base font-medium text-actionDark underline decoration-gray-300 underline-offset-4 hover:decoration-actionDark"
        >
          Create Estate
        </Link>
