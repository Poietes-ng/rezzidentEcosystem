  ...
  return (
    <SafeAreaView className="flex-1 items-center justify-between bg-actionDark px-6 py-10">
      ...
      <View className="flex-row items-center gap-2">
        <Text className="font-dmsans text-[14px] leading-4 text-offWhite">Powered</Text>
        <Text className="font-dmsans text-[14px] leading-4 text-offWhite">|</Text>
        {/* LogoIcon PNG */}
        <Image source={LOGO_ICON_PNG} style={{ width: 14, height: 14 }} resizeMode="contain" />
        <Text className="font-dmsans text-[14px] leading-4 text-offWhite">Poietes</Text>
      </View>
    </SafeAreaView>
  )
}
